...
exports.run = async (bot, msg) => {
    ...
    */
    ...
    } else if (!member.roles.cache.some(role => role.id === '950846744562905108') && (750 < bot.msgCount[msg.author.id].count && bot.msgCount[msg.author.id].count < 3000)) {
    ...
    } else if (!member.roles.cache.some(role => role.id === '950846792315068416') && (1875 < bot.msgCount[msg.author.id].count && bot.msgCount[msg.author.id].count < 7500)) {
    ...
    } else if (!member.roles.cache.some(role => role.id === '950846854545965076') && (3750 < bot.msgCount[msg.author.id].count && bot.msgCount[msg.author.id].count < 14000)) {
    ...
    } else if (!member.roles.cache.some(role => role.id === '950846886653337641') && (7500 < bot.msgCount[msg.author.id].count && bot.msgCount[msg.author.id].count < 20000)) {
    ...
    } else if (!member.roles.cache.some(role => role.id === '950846892827377694') && (15000 < bot.msgCount[msg.author.id].count && bot.msgCount[msg.author.id].count < 40000)) {
