...
module.exports = {
	...
	run: async(client, interaction) => {
        ...
        if (interaction.options.getSubcommand() === "general") {
            ...
            var total = interaction.guild.memberCount;
