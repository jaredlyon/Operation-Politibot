module.exports = {
    ...
    main: async function (bot, msg) {
      ...
      if (!streaks.lastDaily) {
        ...
        await bot.bank.update(account);
        await bot.streaks.update(streaks);
        msg.channel.send(":dollar: | You have received your daily allowance of **$50**! You've also been given a bonus of **$" + (10 * streaks.streak).toFixed(2) + "** due to your **" + streaks.streak + "** day streak, " + msg.author.username + "!");
